...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      Optional<User> optionalUser = Optional.ofNullable(userService.getCarOwner(84739, "AC154"));
      Optional<User> optionalUser2 = Optional.ofNullable(userService.getCarOwner(128700, "AC154"));
      Optional<User> optionalUser3 = Optional.ofNullable(userService.getCarOwner(128759, "AC151"));
      Optional<User> optionalUser4 = Optional.ofNullable(userService.getCarOwner(1287459, "AC154"));
